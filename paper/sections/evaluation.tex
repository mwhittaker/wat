...
relational database.  Some of these overheads can be mitigated---e.g., \fluent{}
...
Redis is a lightweight system, and the time it takes to service a single
minimalist two-byte set request is very low. Thus, even small overheads can
significantly decrease throughput.  While these overheads are fundamental to
our shim-based approach, they will likely decrease as we continue to optimize
\fluent{}'s prototype implementation.
