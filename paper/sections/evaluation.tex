...
Redis' and Zookeeper's \watprovenance{} specifications were expectedly
straightforward.
%
...
% For Redis' \watprovenance{} specification, we categorize each operation as a
% ``write'' (i.e.\ set, del), a ``modification'' (i.e.\ append, incr, decr,
% incrby, decrby), or a ``read'' (i.e. get, strlen). The \watprovenance{} of a
% request for a key involves the most recent write and all subsequent
...
% What was the "width" of the various APIs you wrapped in terms of #API endpoints (you should report this),
% what was the work proportional to each API call?
% Is it kind of a constant effort per API call?
% Any anecdotes about where things got tricky?
% Any intuition regarding things that you would expect to be tricky even though you didn't see them?
