...
\jmh{Im confused how this auditing subsystem relates to Redis, and whether this comparison is apples-to-apples.}
...
instrumentation, it's \jmh{its} execution is significantly slowed because every function
invocation requires the executable to report provenance information to the
SPADE server.

\paragraph{\fluent{}}
\jmh{You really need to describe your shims and specs here!!}
...
\jmh{Well, i dunno about ``taking advantage''. They impose a programmer burden, but in many cases that burden is modest due to...}
As a result,
