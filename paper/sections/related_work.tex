...
generalization of data provenance to programs written in
...
not carry historical information which link prior inputs to present outputs.
For example, traces may show you which clients contacted a key-value store and
when, but they won't show you which requests wrote the values that later
requests read back.
