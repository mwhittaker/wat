...
%
lprof, unlike other tracing tools, constructs traces by analyzing systems'
existing logs; it does not require any program instrumentation. In the future,
we plan to explore whether we can use a similar technique to construct traces
from a system's existing logs.
