...
(1)
  ...
  a_2$ in \figref{Causality}), then $a_i$ happens before $a_j$, and
(2)
...
\figref{DataProvenance} which describes users and friends in a social media
...
a sequence of inputs received by a state machine as a \defword{trace} $T = a_1
a_2 \ldots a_n \in \Sigma^*$. A \defword{subtrace} $T'$ of $T$ is a subsequence
