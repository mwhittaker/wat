...
In \secref{WatProvSpecs}, we showed how easy it was to write shims for a
...
Consider the KVS state machine presented in \exampleref{WatExampleKvs},
...
The WAT provenance of $i = \kvget(x)$ is $\{a_1, a_2\}$.  But explaining why
...
\exampleref{WatExampleXyx}-\exampleref{WatExampleSetDiff} all require
