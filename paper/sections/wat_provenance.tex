...
ordered with respect to another, and to reason about how data is transferred
across multiple machines across a span of time. On the other hand,
\watprovenance{} cannot help us understand why a particular node is
segfaulting; we need a lower-level tool like GDB for this.
