...
data provenance for state machines. We now discuss how \watprovenance{}
provenance relates to \whyprovenance{} and causality.
...
produces a particular output (the \emph{how}).  As a concrete example, consider
