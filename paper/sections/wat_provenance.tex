...
\begin{example}
  ...
  it expectedly outputs $1$ (i.e.\ $\epsilon^*(s_0, Ti) = 1$).
  ...
  generate $o$}. We call such a subtrace a \defword{minimal witness} of $o$.
\end{example}
...
\epsilon^*(s_0, Ti)$, we say that a subtrace $T'$ of $T$ is a \defword{witness}
...
also a witness of $o$. We say a witness $T'$ of $o$ is a \defword{minimal
witness} of $o$ if no subtrace of $T'$ is also a witness of $o$. Finally, the
\defword{\watprovenance{}} of input $i$ and output $o$ with respect to $M$ and
$T$, abbreviated $\Wat{M, T, o}$, is the set of minimal witnesses of $o$ that
