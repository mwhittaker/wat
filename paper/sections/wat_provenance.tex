...
\whyprovenance{} to them\footnote{Note that there are other forms of lineage
(e.g.,~\cite{cui2003lineage}) that can be applied to more generic data
transformation operators.}. Second and more fundamental is \whyprovenance{}'s
