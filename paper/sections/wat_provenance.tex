...
\figref{MeanComment}. \systemname{} users can post statuses to their wall, and
these status updates are only viewable by their friends on the site. Users send
...
\begin{example}\examplelabel{WatExampleAnotbc}
  ...
  $\Mset(a)$ request. From this, we see that in order for a witness $T'$ to be
...
%
Otherwise $t \in Q(I)$ and $o$ is true. Consider a witness $T' \in \Wat{M, T,
