\begin{abstract}
  ...
  events in real-world distributed systems. We observe that automatically
  extracting the \watprovenance{} of a state machine is often infeasible and
  sometimes impossible, depending on the state machine.  Fortunately, many
