\begin{abstract}
  ...
  novel form of provenance that unifies \jmh{inspired by? -- didn't we decide it's not really an extension of causality} causality and data provenance. Given an
  ...
  events in real-world distributed systems. We find \jmh{observe} that automatically
