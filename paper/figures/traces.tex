\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    ...
    \tikzstyle{input}=[draw, minimum width=0.35cm, minimum height=0.35cm,
                       anchor=west, inner sep=0pt, fill opacity=0.4,
                       text opacity=1, line width=\lw]
    \tikzstyle{hiddeninput}=[input, dashed, dash pattern=on 0.05cm off 0.05cm]
    ...
    \end{scope}
  \end{tikzpicture}
  \caption{Subtraces and supertraces}\figlabel{Traces}
\end{figure}
